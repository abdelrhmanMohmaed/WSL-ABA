            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-5">
                    <div class="form-title mt-4 mb-4">
                        <img src="{{ asset('dist/front/assets/images/User,Profile.png') }}" alt="Profile Image">
                        <h3>الجلسات</h3>
                    </div>
                </div>
                <div class="col-md-7 d-flex align-items-center justify-content-md-end justify-content-start">
                    <button class="border-0 edit-file mx-1">
                        <a href="{{ route('kids.treatment-plans.goals.sessions.create', [$kid->id, $goal->id]) }}"
                            class="add-new-appeals">
                            <img src="{{ asset('dist/front/assets/images/plus.png') }}" alt=""> إضافة جلسة
                        </a>
                    </button>
                </div>

                <!-- Session Table or Empty State -->
                @empty($sessions[0])
                    <div class="d-flex justify-content-center pt-5">
                        <div class="d-flex justify-content-center rounded py-4">
                            <div class="text-center">
                                ...
                                <br>
                                <span style="color: #C4C4C4; font-size: 15px">اضغط على زر جلسة للبدء بالجلسة الأولى</span>
                            </div>
                        </div>
                    </div>
                @else
