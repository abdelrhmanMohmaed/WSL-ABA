...
<nav aria-label="breadcrumb mt-5 mb-5">
    <div class="container">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page">
                <a href="{{route('kids.evaluate.appeals.create',$kid->id)}}"><i class="fa-solid fa-chevron-left"></i>
                    تقيم ABLLS
                </a>
            </li>
            ...
            <div id="A" class="container tab-pane active tab-pane-ablis">
                ...
                <div style="height: 1250px!important;" class="letter-container">
                    <div class="B letterHover pt-5">
                        ...
                        <div class="letter-graph d-flex mt-5 h-100">
                            <div class="letter" style="height: 1100px!important; width:100%; text-align: center;">
                                @foreach ($letr->Appale_Nums as $value)
                                    <div class="d-flex justify-content-around">
                                        <div class="question-element" style="position: relative;width: 24px !important;">
                                            <p>{{$value->name}}</p>
                                                    ...
                                                    @if ($vall->ques_id == $value->id)
                                                        @if ($vall->ans_id !== null)
                                                            ...
                                                            <div class="garph-color">
                                                                <span class="line "
                                                                      style="background-color: {{$span4}};"><div
                                                                        class="line-0"></div></span>
                                                                <span class="line"
                                                                      style="    background-color: {{$span2}};"><div
                                                                        class="line-0"></div></span>
                                                                <span class="line "
                                                                      style="    background-color: {{$span3}};"><div
                                                                        class="line-0"></div></span>
                                                                <span class="line"
