            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-12 col-md-5">
                        <div class="form-title mt-4 mb-4 d-flex align-items-center">
                            <img src="{{ asset('dist/front/assets/images/file 2.png') }}" class="img-fluid">
                            <h3 class="ml-3">بيانات المريض</h3>
                        </div>
                    </div>
                    <div
                        class="col-12 col-md-7 d-flex align-items-center justify-content-md-end justify-content-start mb-4 mb-md-0">
                        <button class="border-0 edit-file mx-1">
                            <a href="{{ route('kids.edit', $kid->id) }}">
                                <img src="{{ asset('dist/front/assets/images/edit.png') }}" alt=""
                                    class="img-fluid"> تعديل البيانات
                            </a>
                        </button>
                        <button class="border-0 edit-file mx-1">
                            <a href="{{ route('kids.print', $kid->id) }}">
                                <i class="fas fa-print fa-xl"></i> طباعة
                            </a>
                        </button>
                    </div>
                </div>
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#motherDataShow">بيانات الأم</a>
                    </li>
                    <li class="nav-item">
