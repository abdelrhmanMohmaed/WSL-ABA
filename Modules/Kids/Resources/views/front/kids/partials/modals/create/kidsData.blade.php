<div id="kidsMenu" class="container tab-pane active">
    ...
    <div class="text-data">
        ...
        <div class="form-group">
            ...
            <input id="name" type="text" name="name" placeholder="أدخل اسم كاملاً..."
                   class="form-control"
                   value="{{old('name')}}"/>
            @error('name')
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" placeholder="أدخل رقم الهوية..."
                   value="{{old('num')}}" name="num" maxlength="14"/>
            @error('num')
            <span class="text-danger">
                    <i class="fa fa-info-circle" aria-hidden="true"></i>
                       {{ $message }}
        ...
        <div class="form-group form-date">
            ...
            <input class="form-control datePicker" placeholder="أدخل تاريخ الميلاد..."
                   value="{{old('date')}}" type="text" name="date"/>
            <img src="{{ asset('dist/front/assets/images/calender.png') }}"
                 class="datepickerimg mt-1" width="20px" alt="">
            @error('date')
            <span class="text-danger">
                    <i class="fa fa-info-circle" aria-hidden="true"></i>
                       {{ $message }}
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control"
                   value="{{old('place_date')}}" name="place_date" placeholder="أدخل مكان الميلاد..."/>
            @error('place_date')
            <span class="text-danger">
                    <i class="fa fa-info-circle" aria-hidden="true"></i>
                       {{ $message }}
        ...
        <div class="form-group">
            ...
            <input type="text"  class="form-control" value="{{old('area')}}"
                   placeholder="أدخل  منطقة السكن ..." name="area"/>
            @error('area')
            <span class="text-danger">
                    <i class="fa fa-info-circle" aria-hidden="true"></i>
                       {{ $message }}
        ...
        <div class="form-group" style="position:relative;">
            <label>الجنسية</label>
                ...
                <option selected disabled>اختار الجنسية...</option>
                @foreach ($countries as $item)
                    <option
                        value="{{ $item->id }}" @selected(old('country_id') == $item->id)>{{ $item->name_ar }}</option>
                @endforeach
            </select>
            @error('country_id')
            <span class="text-danger">
    ...
    <div class="text-data">
        ...
        >
            ...
            <div class="comment">
                <input type="text" class="form-control" placeholder="أذكر التعليق هنا..." name="other_obstruction_com"
                       id="comment" value="{{old('other_obstruction_com')}}"
        ...
        >
            <div class="questions d-flex justify-content-between">
                ...
                <div class="custom-control custom-radio">
                    <input type="radio" class="custom-control-input comment-tab" value="1" name="chronic_diseases"
            ...
            <div class="comment">
                <input type="text" class="form-control" placeholder="أذكر التعليق هنا..." name="chronic_diseases_com"
                       id="comment"
                       value="{{ old('chronic_diseases_com') }}"
        ...
        >
            ...
            <div class="comment">
                <input type="text" class="form-control"
                       ...
                       id="comment" value="{{old('genetic_diseases_com')}}"
        ...
        >
            <div class="questions d-flex justify-content-between">
                ...
                <div class="custom-control custom-radio">
                    <input type="radio" class="custom-control-input comment-tab" value="1" name="health_problems"
        ...
        >
            <div class="questions d-flex justify-content-between">
                ...
                <div class="custom-control custom-radio">
                    <input type="radio" class="custom-control-input comment-tab" value="1" name="growth_stage"
                        {{ old('growth_stage') != null && old('growth_stage') == 1 ? 'checked' : '' }} />
                    <label class="custom-control-label">نعم</label>

                    <input type="radio" class="custom-control-input" value="0" name="growth_stage"
