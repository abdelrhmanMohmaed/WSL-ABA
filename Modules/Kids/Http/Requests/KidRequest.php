...
class KidRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            # Dad
            'dad_name' => ['required', 'string', 'min:3'],
            'dad_num' => ['required', 'numeric', 'digits:10'],
            'dad_date' => ['required', 'date', 'date_format:Y-m-d'],
            'dad_marital_status' => ['required', 'in:married,divorce,Widower'],
            'dad_phone' => ['required'],
            'dad_learning' => ['required', 'in:none,primary,middle,secondary,diploma,Bachelor,Master,doctor'],
            'dad_work' => ['required', "in:public_work,private_work,free_work,don't_work"],

            'dad_smoking' => ['required', 'in:0,1'],
            'dad_obstruction' => ['required', 'in:0,1'],
            'dad_obstruction_com' => ["required_if:dad_obstruction,==,1"],
            'dad_chronic_diseases' => ['required', 'in:0,1'],
            'dad_chronic_diseases_com' => ["required_if:dad_chronic_diseases,==,1"],
            'dad_genetic_diseases' => ['required', 'in:0,1'],
            'dad_genetic_diseases_com' => ['required_if:dad_genetic_diseases,==,1'],
            'dad_mental_state' => ['required', 'in:0,1'],
            'dad_mental_state_com' => ['required_if:dad_mental_state,==,1'],
            'dad_health_problems' => ['required', 'in:0,1'],
            'dad_health_problems_com' => ['required_if:dad_health_problems,==,1'],
            'dad_communication' => ['required'],
            'dad_communication_com' => ['nullable', 'string'],

            # mom
            'mom_name' => ['required', 'string', 'min:3'],
            'mom_num' => ['required', 'numeric', 'digits:10'],
            'mom_date' => ['required', 'date', 'date_format:Y-m-d'],
            'mom_marital_status' => ['required', 'in:married,divorce,Widower'],
            'mom_phone' => ['required'],
            'mom_learning' => ['required', 'in:none,primary,middle,secondary,diploma,Bachelor,Master,doctor'],
            'mom_work' => ['required', "in:public_work,private_work,free_work,don't_work"],

            'mom_smoking' => ['required', 'in:0,1'],
            'mom_obstruction' => ['required', 'in:0,1'],
            'mom_obstruction_com' => ["required_if:mom_obstruction,==,1"],
            'mom_chronic_diseases' => ['required', 'in:0,1'],
            'mom_chronic_diseases_com' => ["required_if:mom_chronic_diseases,==,1"],
            'mom_genetic_diseases' => ['required', 'in:0,1'],
            'mom_genetic_diseases_com' => ['required_if:mom_genetic_diseases,==,1'],
            'mom_mental_state' => ['required', 'in:0,1'],
            'mom_mental_state_com' => ['required_if:mom_mental_state,==,1'],
            'mom_health_problems' => ['required', 'in:0,1'],
            'mom_health_problems_com' => ['required_if:mom_health_problems,==,1'],
            'mom_communication' => ['required'],
            'mom_communication_com' => ['nullable', 'string'],

            'mom_pregnancy' => ['required', 'in:0,1,2'],
            'mom_pregnancy_com' => ["required_if:mom_pregnancy,==,1"],
            'mom_pregnancy_month' => ['required', 'in:7,8,9,10'],
            'mom_pregnancy_problems' => ['required', 'in:0,1'],
            'mom_pregnancy_problems_com' => ["required_if:mom_pregnancy_problems,==,1"],
            'mom_birth_status' => ['required', 'in:0,1'],
            'mom_birth_problems' => ['required', 'in:0,1'],
            'mom_birth_problems_com' => ["required_if:mom_birth_problems,==,1"],
            'mom_birth_after_problems' => ['required', 'in:0,1'],
            'mom_birth_after_problems_com' => ["required_if:mom_birth_after_problems,==,1"],
            'mom_lactation' => ['required', 'in:0,1'],

            # Family
            'family_num_of' => ['required'],
            'family_num_of_pro' => ['required'],
            'family_num_of_sis' => ['required'],
            'family_sort_of' => ['required'],
            'family_bro_autism' => ['required'],
            'family_has_twins' => ['required'],
            'family_marital_status' => ['required'],
            'family_with_live' => ['required'],
    ...
    public function messages(): array
    {
        return [
            ...
            'country_id.required' => 'الجنسية مطلوبه',
