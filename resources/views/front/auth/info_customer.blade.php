...
@section('content')
    ...
    <div class="main-colored">
        ...
        <div class="register-form">
            <div class="container">
                <div class="row">
                    <form class="personal-data" action="{{ route('update_profile_info') }}"
                        ...
                        <div class="user-detailss justify-content-start w-100">
                            <div class="user-img">
                                ...
                                <img
                                    src="{{asset('uploads/customers/avatar/'.auth()->guard('customer')->user()->avatar)}}"
                                    id="user_img" alt=""/>
                            </div>
                            <div class="user-name">
                        ...
                        <div class="form_item d-flex">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="degree" required>
                                    ...
                                    <option value="Master"
                                        @selected(auth()->guard('customer')->user()->degree=='Master') >
                                        ماجستير
                                    </option>
                                    <option value="doctor"
                                        @selected(auth()->guard('customer')->user()->degree == 'doctor')>
                                        دكتوراه
                                    </option>
                                </select>
                            </div>
                                ...
                                <div class="pdf-img">
                                    @foreach(auth()->guard('customer')->user()->Files as $key => $value)
                                        <div class="pdf-item">
                                            ...
                                            <a href="{{route('destroy.certification',$value->id)}}" class="close" onclick="removeFile(event)">
